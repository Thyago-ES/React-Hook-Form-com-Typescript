		...
		>
			...
			<div className="flex flex-col gap-2 mb-2">
				...
				>
					...
					<option value="elu">Honda Civic</option>
				</select>
				{errors.gender && (
			...
			<div className="flex flex-col gap-2 mb-2">
				<div className="flex gap-2">
					...
					<label htmlFor="agree">Aceito os termos.</label>
					{errors.agree && (
						<small className="text-red-500 italic">
			...
			<button
				type="submit"
				className="w-full h-11 bg-cyan-400 rounded-md my-2 text-white font-bold hover:bg-cyan-500 transition-all"
			>
				Cadastrar
			</button>
		</form>
